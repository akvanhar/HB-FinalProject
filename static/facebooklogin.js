  ...
  //     var accessToken = response.authResponse.accessToken; //store this in session
...
function submit_info_to_server(response) {
      ...
      user_fname_element.value = user_fname;
      user_lname_element.value = user_lname;
      user_email_element.value = user_email;
  ...
  function getUserDetails() {
    ...
    FB.api('/me', {fields: ['last_name', 'first_name', 'email', 'user_id']}, function (response) {
      if (response && !response.error) {
        ...
        return user_email, user_fname, user_lname;
        }
      });
  }